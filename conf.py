...
BLOG_AUTHOR = "Rens Dimmendaal"  # (translatable)
BLOG_TITLE = "My Shared Notes"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://rensdimmendaal.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://rensdimmendaal.com/"
BLOG_EMAIL = "first@lastname.com"
BLOG_DESCRIPTION = "On this website I share my notes"  # (translatable)
